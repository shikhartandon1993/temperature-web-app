 ...
 */
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_blink_off;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_blink_on;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_blink_toggle;
